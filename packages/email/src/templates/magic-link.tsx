 ...
 * convenient.
 */
export function MagicLinkEmail({ signInUrl, code, workspaceName, logoUrl }: MagicLinkEmailProps) {
  return (
    <EmailLayout preview="Your sign-in link" logoUrl={logoUrl} logoAlt={workspaceName}>
